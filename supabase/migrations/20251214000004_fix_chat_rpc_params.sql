...
-- We rename current_user_id -> p_user_id to be absolutely sure
...
COMMENT ON FUNCTION public.get_chat_conversations_v2(uuid) IS 'Versión final v4: parámetro p_user_id';
