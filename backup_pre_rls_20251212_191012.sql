...
CREATE TABLE IF NOT EXISTS "public"."api_health_logs" (
    ...
    CONSTRAINT "api_health_logs_status_check" CHECK (("status" = ANY (ARRAY['success'::"text", 'failed'::"text"])))
);


ALTER TABLE "public"."api_health_logs" OWNER TO "postgres";


COMMENT ON TABLE "public"."api_health_logs" IS 'Registra los intentos de conexión a APIs externas de tasas de cambio';



COMMENT ON COLUMN "public"."api_health_logs"."api_name" IS 'Nombre de la API (dollarvzla.com, pydolarvenezuela, exchangerate-api)';



COMMENT ON COLUMN "public"."api_health_logs"."status" IS 'Estado del intento: success o failed';



COMMENT ON COLUMN "public"."api_health_logs"."response_time_ms" IS 'Tiempo de respuesta en milisegundos';



COMMENT ON COLUMN "public"."api_health_logs"."error_message" IS 'Mensaje de error si el intento falló';



COMMENT ON COLUMN "public"."api_health_logs"."rate_obtained" IS 'Tasa de cambio obtenida si el intento fue exitoso';



CREATE SEQUENCE IF NOT EXISTS "public"."api_health_logs_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."api_health_logs_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."api_health_logs_id_seq" OWNED BY "public"."api_health_logs"."id";
...
CREATE TABLE IF NOT EXISTS "public"."orders" (
    ...
    "archived_by_admin" boolean DEFAULT false,
...
ALTER TABLE ONLY "public"."api_health_logs" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."api_health_logs_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."api_health_logs"
    ADD CONSTRAINT "api_health_logs_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_api_health_logs_api_name" ON "public"."api_health_logs" USING "btree" ("api_name");



CREATE INDEX "idx_api_health_logs_api_name_created_at" ON "public"."api_health_logs" USING "btree" ("api_name", "created_at" DESC);



CREATE INDEX "idx_api_health_logs_created_at" ON "public"."api_health_logs" USING "btree" ("created_at" DESC);
...
CREATE OR REPLACE TRIGGER "assign_order_on_insert" BEFORE INSERT ON "public"."orders" FOR EACH ROW EXECUTE FUNCTION "public"."assign_order_to_employee"();
...
CREATE POLICY "Admins can read api health logs" ON "public"."api_health_logs" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."administrators"
  WHERE ("administrators"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Admins can view all userlevels" ON "public"."userlevel" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."administrators"
  WHERE ("administrators"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Authenticated can view administrators" ON "public"."administrators" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Service role can insert api health logs" ON "public"."api_health_logs" FOR INSERT TO "service_role" WITH CHECK (true);
...
CREATE POLICY "Service role can read api health logs" ON "public"."api_health_logs" FOR SELECT TO "service_role" USING (true);
...
CREATE POLICY "Users can view own userlevel" ON "public"."userlevel" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "id"));
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."api_health_logs";
...
GRANT ALL ON TABLE "public"."api_health_logs" TO "anon";
GRANT ALL ON TABLE "public"."api_health_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."api_health_logs" TO "service_role";



GRANT ALL ON SEQUENCE "public"."api_health_logs_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."api_health_logs_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."api_health_logs_id_seq" TO "service_role";
